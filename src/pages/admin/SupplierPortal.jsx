...
import { Printer, Search, ArrowLeft, Calendar, FileText, CheckCircle2, ShieldAlert } from 'lucide-react';
              ...
              <div className="flex-between" style={{ flexWrap: 'wrap', gap: '1rem', borderBottom: '1px solid var(--border-color)', paddingBottom: '1.25rem', marginBottom: '1.25rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
                  ...
                  <button 
                    ...
                    style={{ padding: '0.5rem 1rem', fontSize: '0.85rem', gap: '0.35rem', cursor: 'pointer' }}
                  >
                    <Printer size={16} />
                    Customer Bill
                  </button>
                  <button 
                    onClick={() => handlePrint(order, 'supplier')} 
